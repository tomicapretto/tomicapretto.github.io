...
![Example bingo card from bingo.es](files/bingo_card.png)
...
![Example bingo strip from bingo.es](files/bingo_strip.PNG)
...
![](files/valid_row_1.PNG)
![](files/valid_row_2.PNG)
...
![](files/invalid_row_1.PNG)
![](files/invalid_row_2.PNG)
...
```{r execution, cache=TRUE, message=FALSE}
set.seed(0303456)
rows = get_rows()
...
![First card in the output](files/bingo_card_own.PNG)

</center>

If you can't (or just don't want to) run the code, 
[here](files/strips.pdf) you have the generated
pdf.